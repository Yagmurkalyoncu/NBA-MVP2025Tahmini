...
predicted_mvp = [
    "Kevin Garnett", "Allen Iverson", "LeBron James", "Steve Nash", "LeBron James",
    "Chris Paul", "LeBron James", "LeBron James", "LeBron James", "LeBron James",
    "Kevin Durant", "Russell Westbrook", "Russell Westbrook", "Russell Westbrook", "Lebron James",
    "James Harden", "James Harden", "Nikola Jokic", "Nikola Jokic","Nikola Jokic",
    "Luka Doncic"
]
...
plt.title("Logistic Regression MVP Tahminleri vs Gerçek MVP'ler (2004–2024)", fontsize=14, fontweight='bold')
