...
# Gerçek MVP'ler (2015-2024)
true_mvp = [
    "Stephen Curry", "Stephen Curry", "Russell Westbrook", "James Harden", "Giannis Antetokounmpo",
    "Giannis Antetokounmpo", "Nikola Jokic", "Nikola Jokic", "Joel Embiid","Nikola Jokic"
]

# Random Forest Tahminleri (2015-2024)
predicted_mvp = [
    "Stephen Curry", "Stephen Curry", "Russell Westbrook", "James Harden","Giannis Antetokounmpo", "Giannis Antetokounmpo","Nikola Jokic", "Nikola Jokic",
...
plt.title("Random Forest MVP Tahminleri vs Gerçek MVP'ler (2015–2024)", fontsize=14, fontweight='bold')
