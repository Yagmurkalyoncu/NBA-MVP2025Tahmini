...
predicted_mvp = [
     "Russell Westbrook", "Russell Westbrook", "Russell Westbrook", "LeBron James","Giannis Antetokounmpo", "Giannis Antetokounmpo",
     "Nikola Jokic","Nikola Jokic","Nikola Jokic","Luka Doncic"
]
...
plt.title("Logistic Regression MVP Tahminleri vs Gerçek MVP'ler (2015–2024)", fontsize=14, fontweight='bold')
